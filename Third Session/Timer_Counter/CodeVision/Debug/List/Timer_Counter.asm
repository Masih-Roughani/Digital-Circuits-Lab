...
;	st -> Y+0
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 0020     if (tenth == 10){Sec++; tenth = 0;}
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CP   R30,R4
	CPC  R31,R5
...
_0x3:
	...
	CLR  R6
	CLR  R7
; 0000 0022     if (Min == 60){Hour++; Min=0;}
_0x4:
	LDI  R30,LOW(60)
	LDI  R31,HIGH(60)
	CP   R30,R8
...
_0x5:
	...
	CLR  R10
	CLR  R11
; 0000 0024     sprintf(st,"%d : %d : %d",Hour,Min,Sec);
_0x6:
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 0035 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 0036 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 0037 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 0048 // Clock value: 0.977 kHz
; 0000 0049 // Mode: CTC top=OCR0
; 0000 004A // OC0 output: Toggle on compare match
; 0000 004B // Timer Period: 99.328 ms
; 0000 004C // Output Pulse(s):
; 0000 004D // OC0 Period: 0.19866 s Width: 99.328 ms
; 0000 004E TCCR0=(0<<WGM00) | (0<<COM01) | (1<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(29)
	OUT  0x33,R30
...
; 0000 0053 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(2)
	OUT  0x39,R30
; 0000 0054 
...
; 0000 0058 // RS - PORTA Bit 0
; 0000 0059 // RD - PORTA Bit 1
; 0000 005A // EN - PORTA Bit 2
; 0000 005B // D4 - PORTA Bit 4
; 0000 005C // D5 - PORTA Bit 5
; 0000 005D // D6 - PORTA Bit 6
; 0000 005E // D7 - PORTA Bit 7
